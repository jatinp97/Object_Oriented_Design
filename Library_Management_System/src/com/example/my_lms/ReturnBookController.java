...
// Represents class ReturnBookController which implements Initializable
public class ReturnBookController implements Initializable {
    ...
    // Initializing Array list to store books
    ...
    // Implemented ReturnAction() method for returning book issued by student.
	...
	// initialize() method used to show returned book
    @Override
    ...
    //Method showReturnBook() to show details of return bookid, bookname, issued date and due date.
    ...
    // Implemented method ivBackAction to switch to the student screen on occurrence of mouseEvent
