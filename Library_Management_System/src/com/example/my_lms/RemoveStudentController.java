...
// Represents class RemoveStudentController which implements Initializable
public class RemoveStudentController implements Initializable {
    ...
    // Initializing Array list to store students list
    ObservableList<Student> list = FXCollections.observableArrayList();

	/* Override the initialize() method defined in the studentController class*/
	// initialize() method used to show student data
    @Override
    ...
    // Implemented DeletAction() method for remove any student from student list
    public void DeleteAction(ActionEvent actionEvent) {
        ...
        try {
            ...
            stnt.close();
            con.close();
// alert that shows up on successful deletion of student
    ...
    // Implemented RefreshAction method to show student data and set text in search to " "
    ...
    // SearchAction method to show student data on search.
    ...
    // Implemented method ivBackAction to switch to the Admin screen
    ...
    //showStudData() method to show updated student data list.
