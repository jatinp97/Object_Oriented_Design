...
//Represents AdminIssueBookController class which implements Initializable
public class AdminIssueBookController  implements Initializable{
    ...
    //IssueAction() methos used to issue book
    public void IssueAction(ActionEvent actionEvent) {
        ...
        try{
            ...
            if(dpIssueDate.getValue() == null || dpDueDate.getValue() == null){
                ...
                //alert the user to enter issue and due date
            ...
            //alert used to notify customer on successful issue of book
            Alert a = new Alert(Alert.AlertType.INFORMATION);
    ...
    //CancelAction() method used to cancel the issue book requested by student
    public void CancelAction(ActionEvent actionEvent) {
        ...
        try{
            ...
            //alert used to notify user that Request to issue book is canceled
            Alert a = new Alert(Alert.AlertType.INFORMATION);
    ...
    /* Override the initialize() method defined in the studentController class*/
   	// initialize() method used to show call showissueBook() method.
    @Override
    ...
    //showIssueBook() method to show details of issued books
