...
// represents class AdminReturnBookController implements Initializable
public class AdminReturnBookController implements Initializable {
    ...
    //Initialized an array list to store book details
	...
	// initialize() method used to show call showReturnBooks() method.
    @Override
    ...
    //showReturnBooks() used to retrieve  return books information
    ...
    //ReturnBookAction() method to return updated book details after inert/delete/update actions 
    public void ReturnBookAction(ActionEvent actionEvent) {
        ...
        try {
            ...
            // Alert to notify user that book is returned successfully
            showReturnBooks();
