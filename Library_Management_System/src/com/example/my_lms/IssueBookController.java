...
//Represents IssueBookController to issue books to student
public class IssueBookController  implements Initializable{
    ...
    //Initialising an Arraylirt to store book details    
	...
	// initialize() method used to show Book Table
   @Override
    ...
    // showBookTable() used to show books issuing to students.
    ...
    // Implemented IssueBookAction() method to issue books to students based on book status.
    ...
    // Implemented SearchAction() method to help user to search while issuing books
    ...
    // Implemented SearchAction() method to help user to refresh the search while issuing books
    ...
    // Implemented method ivBackAction to switch to student window.
